const menuList = [
  ...
  },
  {
    ...
    'children': [
      ...
      {
        'id': 12,
        'menuCode': 'dynamicrequiredManagement',
        'title': '動態必填管理',
        'menuType': 2,
        'openType': 3,
        'viewType': 4,
        'link': 'SiteDynamicRequired',
        'iconName': 'spinner',
        'iconColor': null,
        'sizeWidth': null,
        'sizeHeight': null,
...
const systemConfigs = [
  {
    'name': 'ADMIN_DEFAULT_GROUP_ID',
    'value': '3',
    'description': '管理員預設權限群組 Id',
  },
]
